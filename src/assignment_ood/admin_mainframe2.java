 ...
 * @author PC
 */
public class admin_mainframe2 extends javax.swing.JFrame {
...
//        TabPanel.addTab("tab5", Tab5);
    ...
    private void initComponents() {
        ...
        getContentPane().add(TabPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(295, 94, 790, 570));

        addLect.setText("Add Lecture");
        addLect.addComponentListener(new java.awt.event.ComponentAdapter() {
            public void componentHidden(java.awt.event.ComponentEvent evt) {
                addLectComponentHidden(evt);
            }
        });
        ...
        getContentPane().add(addLect, new org.netbeans.lib.awtextra.AbsoluteConstraints(1140, 570, -1, -1));
    ...
    private void addLectComponentHidden(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_addLectComponentHidden
        // TODO add your handling code here:
    }//GEN-LAST:event_addLectComponentHidden
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(admin_mainframe2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new admin_mainframe2().setVisible(true);
            }
        });
    }
