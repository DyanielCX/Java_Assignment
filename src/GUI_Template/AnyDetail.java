...
public class AnyDetail {
    ...
    data structure (current) -> Student ID, Lecturer Name, Assessment, Presentation Date, Presentation Time,Student Staus, Reject Reason. Second Marker,Supervisor status, Second marker status
    ReportData.txt
